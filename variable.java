public class variable {
    public static void main(String[] args){
     /** variable is like a container to store the data of any type. or simply is a memory location*/ 
     // syntax of declaration   ->   data_type variable_name ;
     //primitive data type 

     boolean flag=true; // used for tracking true/flase conditions
     ...
     /**we can print any value bye this statement */
    }
}
